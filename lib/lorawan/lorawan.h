...
class LoRaWAN {
  ...
  private:
    ...
    linearBuffer<64> macIn;         // buffer holding the received MAC requests and/or answers
    linearBuffer<64> macOut;        // buffer holding the MAC requests and/or answers to be sent
